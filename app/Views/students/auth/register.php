...
<body>
  <div class="container-scroller">
    ...
    <?php endif; ?>
              <form class="pt-3" method="post" action="<?=base_url('user/reg')?>">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="First_Name" class="form-control form-control-sm border-left-0" placeholder="First name" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="Last_Name" class="form-control form-control-sm border-left-0" placeholder="Last Name">
                  </div>
                </div>
                <div class="form-group">
                  <label>Email</label>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="phone" class="form-control form-control-sm border-left-0" placeholder="phone" >
                  </div>
                </div>
...
-->
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="<?=base_url('student_login')?>" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
