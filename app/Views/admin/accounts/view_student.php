                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <td style="color:green; font-weight:bold;">Phone</td>
                          ...
                          <button type="button" class="btn btn-light" data-toggle="modal" data-target="#sms" data-whatever="@mdo">sms</button>
                        </td>
                        ...
                        <td style="color:green; font-weight:bold;">Status</td>
                          ...
                          <?php if ($data['isenrolled']==1): ?>
                            Approved
                            <?php elseif($data['isenrolled']==0): ?> 
                              Pending
                           <?php elseif($data['isenrolled']==2): ?> 
                              Deferred
                              <?php elseif($data['isenrolled']==3): ?> 
                            Rejected
                         <?php endif ?>
                        </td>
