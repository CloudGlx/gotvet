              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    ...
                    <?php
                    $query = $db->query("SELECT * FROM orders WHERE OrderStatus<=4 ORDER BY ID DESC");
                    ?>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <?php elseif ($row['OrderStatus'] == 0) : ?>
                                <label class="badge badge-warning">Awaitng Approval</label>
                            ...
                            <td>
                              <a href="<?= base_url('vieworder/' . $row['OrderId']) ?>"> <i class="fa fa-eye"></i>View</a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
