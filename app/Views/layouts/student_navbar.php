...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="#"><img src="<?=base_url()?>/public/assets/images/gologo.png" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="#"><img src="<?=base_url()?>/public/assets/images/gotvet.png" alt="logo"/></a>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item d-none d-lg-flex">
            ...
            <a href="#" ><span class="btn btn-primary">Apply Now</span></a>
            </a>
          </li>

          <li class="nav-item d-none d-lg-flex">
            <a class="nav-link" href="#">
              <span class="btn btn-success">Busket: 0<span> </span></span>
            </a>
          </li>
          ...
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <div class="dropdown-divider"></div>
              <a href="<?=base_url('admin/pass_reset')?>" class="dropdown-item">
                <i class="fa fa-key text-primary"></i>
                Password Reset 
              </a>

              <div class="dropdown-divider"></div>
              <a href="<?=base_url('student_logout')?>" class="dropdown-item">
