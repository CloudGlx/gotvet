                      ...
                      <div class="card-body">
                        ...
                        <div class="table-responsive">
                          <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="#"><label class="btn btn-primary btn-fw">Pay Now</label></a></td>
                          ...
                          <?php if ($data['OrderStatus'] == '0') : ?>
                            ...
                            <a href="<?= base_url('order_cancle/' . $data['OrderId']) ?>"> <button class="btn btn-danger btn-fw">Cancel</button> </a>
                  ...
                  <div class="col-lg-6 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <?php if ($data['OrderStatus'] == 0) : ?>
                        <h4 class="card-title" style="color:Green;">My Files</h4>
                          <div class="table-responsive">
                            <?php
                            ...
                            <a href="<?= base_url('file_upload/' . $data['OrderId']) ?>">
                              <button type="button" class="btn btn-outline-danger btn-icon-text">
