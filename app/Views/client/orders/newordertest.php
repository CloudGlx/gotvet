...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>/public/ordres/font-awesome/css/fontawesome-all.min.css">
  <!-- Custom styles for this template -->
  <link href="<?=base_url()?>/public/ordres/opskill-styles.css" rel="stylesheet">
  <link href="<?=base_url()?>/public/ordres/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <script src="<?=base_url()?>/public/ordres/bootstrap/js/jquery.min.js"></script>
  <script src="<?=base_url()?>/public/ordres/bootstrap/js/bootstrap.min.js"></script>
...
<head>
  ...
  <link rel="alternate" type="application/rss+xml" title="Cloud Galaxy &raquo; Feed" href="../feed/index.html" />
  <link rel="alternate" type="application/rss+xml" title="Cloud Galaxy &raquo; Comments Feed"
    href="../comments/feed/index.html" />
  <script>
    window._wpemojiSettings = { "baseUrl": "https:\/\/s.w.org\/images\/core\/emoji\/14.0.0\/72x72\/", "ext": ".png", "svgUrl": "https:\/\/s.w.org\/images\/core\/emoji\/14.0.0\/svg\/", "svgExt": ".svg", "source": { "concatemoji": "https:\/\/cloudgalaxytech.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.0.1" } };
...
<body class="wp-custom-logo sfsi_actvite_theme_default">
  ...
  <link rel="stylesheet" type="text/css" href="<?=base_url()?>public/ordres/dropzone/basic.min.css">
  <script type="text/javascript" src="<?=base_url()?>public/ordres/dropzone/jquery.html"></script>
  <script type="text/javascript" src="<?=base_url()?>public/ordres/dropzone/dropzone.min.js"></script>
  <script src="<?=base_url()?>public/ordres/ckeditor/ckeditor.js"></script>
  <style>
      ...
      <div class="row">
        <div class="col-lg-9 col-md-12">
          <div class="borderdottedleft">
            <div class="rc-orderform__step-flag col-sm-12">

              <div class="text-center col-sm-12 p-3 mx-auto">
                <p style="font-size: 11px; margin-bottom: 0px"> Our prices start from $10.26. All papers are written
                  from scratch according to your instructions by professional writers. </p>
                <p style="font-size: 11px; margin-bottom: 0px">You will get a high quality plagiarism free paper
                  delivered to your email on time.</p>
                <p style="font-size: 11px; margin-bottom: 0px">You will also get a FREE plagiarism report alongside your
                  completed paper </p>
                <p style="font-size: 14px; font-weight: bold; margin-bottom: 0px">We guarantee HIGH QUALITY OF OUR
                  CUSTOM WRITING and PROFESSIONAL SUPPORT AVAILABLE 24/7 </p>
              </div>
  ...
  <div class="form-group row">
                ...
                <div class="col-lg-9 col-md-12">
                  <div class="btn-group row opclick" data-toggle="buttons">
                    <label class="col-sm-3  btn btn-default ">
                      <input type="radio" name="ops_aclevel" id="ops_aclevel" value="1#High School">High School</input>
                    </label>
                    <label class="col-sm-3  btn btn-default ">
                      <input type="radio" name="ops_aclevel" id="ops_aclevel"
                        value="1.13#Undergraduate">Undergraduate</input>
                    </label>
                    <label class="col-sm-3  btn btn-default active">
                      <input type="radio" name="ops_aclevel" id="ops_aclevel" value="1.3#Masters"
                        checked>Masters</input>
                    </label>
                    <label class="col-sm-3  btn btn-default ">
                      <input type="radio" name="ops_aclevel" id="ops_aclevel" value="1.5#PhD">PhD</input>
                    </label>
              ...
              <div class="form-group row">
                <label for="exampleSelect1" class="col-sm-3">Type of Paper</label>
                <select name="order_tpaper" class="form-control custom-select border-default col-sm-8"
                  id="exampleSelect1">
          ...
          <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="exampleTextarea" class="col-sm-3">Paper Instructions</label>
                <div class="col-sm-8">
                  <div class="row">
              ...
              <div class="col-sm-12">
                <div class="pricecalculate">
                  ...
                  <input id="words" type="hidden" value="275"
                    style="width: 100px;border: 0px solid #fff;text-align: right" />
  ...
  <script type="text/javascript">
    ...
    $(document).on("change", function () {
      ...
      var num = ((parseFloat(cap) * parseFloat(ac) * parseFloat(tpaper) * parseFloat(currency) * parseFloat(subject) * parseFloat(tier) * parseFloat(spacing) * parseFloat(pages)) + parseFloat(addon) + parseFloat(slides)) * parseFloat(cpn_value);
      var ordert = parseFloat(cap) * parseFloat(ac) * parseFloat(tpaper) * parseFloat(currency) * parseFloat(subject) * parseFloat(tier) * parseFloat(spacing) * parseFloat(pages);
      ...
      var perpageright = parseFloat(cap) * parseFloat(ac) * parseFloat(currency) * parseFloat(tier) * parseFloat(spacing);
      ...
      if (cctwo > 0) {
        $(".order_discountrightprice").html(currency_right1 + " " + cctwo);
      }
...
00
  ...
  <div class="pricingbottom bg-warning">
